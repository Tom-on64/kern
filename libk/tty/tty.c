...
int32_t terminalWrite(const void* buf, uint32_t len) { // TODO fix font size
    terminal->width = gfxMode->xRes / 8;//*(uint8_t*)(FONT_LOC);
    terminal->height = gfxMode->yRes / 16;//*(uint8_t*)(FONT_LOC+1);
